 ...
 *@创建时间  2020/5/9
 */
public class WorkflowTransferOfPersonnelJJ extends BaseBean implements Action{
...
//        }
        ...
        //请假单ID
        sql="select sj2,sqrhr,dcgw,drgw from "+formTableName+"_dt1 where mainid="+mainid;
        rs.execute(sql);
        while (rs.next()){
            ...
            tbody.put("EffectiveDate",Util.null2String(rs.getString("sj2")));
            tbody.put("empcode",Util.null2String(rs.getString("sqrhr")));
            tbody.put("empname","");
            tbody.put("AdjustType","01");
            tbody.put("DeptBefore",Util.null2String(mainTableDataMap.get("dcbm")));
            tbody.put("DeptAfter",Util.null2String(mainTableDataMap.get("drbm")));
            tbody.put("FDeptBefore","");
            tbody.put("FDeptAfter","");
            tbody.put("GWBefore",0);//mainTableDataMap.get("dcgw")Util.null2String(rs.getString("dcgw"))
            tbody.put("GWAfter",Util.null2String(rs.getString("drgw")));//
            tbody.put("ZJBefore","");
            tbody.put("ZJAfter","");
            ...
            tbody.put("ZJLDBefore","");
            tbody.put("ZJLDAfter","");
            tbody.put("WelfSBefore","");
            tbody.put("WelfSAfter","");
            //调整薪资棕
