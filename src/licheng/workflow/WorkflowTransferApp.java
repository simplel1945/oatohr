 ...
 *@创建时间  2020/5/9
 */
public class WorkflowTransferApp extends BaseBean implements Action{

    private String interfaceName="转岗申请流程对接HR接口";
    /**
     * @Author 李志辉
     * @Description 转岗申请流程
     * * @Date 2019/8/14
    ...
    private JSONObject getParam(Map<String,String> mainTableDataMap, int requestid, String formTableName){
        ...
        json.put("ProcName", "WSPROC_TransferApp");
        //考核月份
...
//        }
        ...
        while (rs.next()){
            ...
            tbody.put("ApplyDate","2019-09-22 00:00:00.000");
            tbody.put("empcode","08000570");
            tbody.put("empname","董召斌");
            tbody.put("FullNameBefore","总部");
            tbody.put("FullNameAfter","总部");
            tbody.put("DeptBefore","10905001001");
            tbody.put("DeptAfter","10909007");
            tbody.put("FDeptBefore","10905");
            tbody.put("FDeptBefore","10909");
            tbody.put("GWBefore",0);
            tbody.put("GWAfter",8);
            tbody.put("TransferExp",'无');
            tbody.put("TransferDate", "2019-09-22 00:00:00.000");
            tbody.put("TransferReason","测试");
            list.add(tbody);
        }
