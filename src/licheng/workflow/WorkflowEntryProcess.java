 ...
 *@创建时间  2020/5/9
 */
public class WorkflowEntryProcess extends BaseBean implements Action{
    private String interfaceName="入职流程对接HR接口";
    /**
     * @Author 李志辉
     * @Description 入职流程流程
     * @Date 2019/8/14
...
//        }
        ...
        while (rs.next()){
            ...
            tbody.put("EmployOAID","rysp201905230001");
            tbody.put("empcode",Util.null2String(mainTableDataMap.get("gh")));
            tbody.put("empname","");
            tbody.put("Email","");
            tbody.put("hiredate",Util.null2String(mainTableDataMap.get("rzrq")));
            tbody.put("OpenEmailbox",Util.null2String(mainTableDataMap.get("spjg")));
