 ...
 *@创建时间  2020/5/9
 */
public class WorkflowAttSendLeaveTX extends BaseBean implements Action{
    private String interfaceName="请假调休对接HR接口";
    @Override
...
//        }
        ...
        sql="select id,kssj,jbrq,kssj1,jbrq1,jssj1,jbjs1,zts from "+formTableName+"_dt1 where mainid="+mainid;
        writeLog("----------"+sql);
        rs.execute(sql);
        while (rs.next()){
            ...
            json_.put("OASubID",Util.null2String(rs.getString("id")));
            ...
            json_.put("LeaveBegin",Util.null2String(rs.getString("kssj")));
            json_.put("BeginTime",Util.null2String(rs.getString("kssj1")));
            json_.put("LeaveEnd",Util.null2String(rs.getString("kssj")));
            json_.put("EndTime",Util.null2String(rs.getString("jssj1")));
            json_.put("LeaveDay",Util.null2String(rs.getString("zts")));
            json_.put("LeaveHour",0);
            json_.put("LeaveStatus",1);
            json_.put("LeaveReason",Util.null2String(mainTableDataMap.get("ccsy")));
            json_.put("JBKS_TIME",Util.null2String(rs.getString("jbrq1")));
            json_.put("JBJS_TIME",Util.null2String(rs.getString("jbjs1")));
            json_.put("JB_DAY",Util.null2String(rs.getString("jbrq")));
            list.add(json_);
        }
