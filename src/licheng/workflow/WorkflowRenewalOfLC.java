 ...
 *@创建时间  2020/5/9
 */
public class WorkflowRenewalOfLC extends BaseBean implements Action{
...
//        }
        ...
        while (rs.next()){
            ...
            //OA流程编号
            tbody.put("OAID",Util.null2String(rs.getString("oaid")));
            ...
            tbody.put("EffectiveDate",Util.null2String(mainTableDataMap.get("xldhtqdrq")));
