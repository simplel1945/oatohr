 ...
 *@创建时间  2020/5/9
 */
public class WorkflowFloatingWage extends BaseBean implements Action{
    private String interfaceName="浮动工资对接HR接口";
    /**
     * @Author 李志辉
     * @Description 浮动工资流程
     * @Date 2019/8/14
    ...
    private net.sf.json.JSONObject getParam(Map<String,String> mainTableDataMap, int requestid, String formTableName){
        ...
        json.put("ProcName", "WSPROC_FloatingWage");
        //考核月份
...
//        }
        ...
        while (rs.next()){
            ...
            tbody.put("GZ_YM","201905");
            tbody.put("empcode","08000570");
            tbody.put("empname","");
            tbody.put("ProjectName","补发工资");
            tbody.put("ProjectMoney",300);
            tbody.put("ProjectType","其他补贴");
            tbody.put("TaxRelated","否");
            tbody.put("ApplyReason","晚餐补贴");
            tbody.put("Remark","测试");
            list.add(tbody);
        }
