 ...
 *@创建时间  2020/5/9
 */
public class WorkflowRetireApproval extends BaseBean implements Action{
    private String interfaceName="离职审批对接HR接口";
    /**
     * @Author 李志辉
     * @Description 离职审批通过申请流程
     * @Date 2019/8/14
     * @Param [request]
...
//        }
        ...
        while (rs.next()){
            ...
            tbody.put("empname","");
            tbody.put("RetireBefore","在职人员");
            tbody.put("RetireAfter","离职人员");
            tbody.put("RetireReason",Util.null2String(mainTableDataMap.get("lzyyhr")));
            tbody.put("RetireType",Util.null2String(mainTableDataMap.get("lzlx")));
            tbody.put("RetireDate",Util.null2String(mainTableDataMap.get("lzsj")));
            tbody.put("A01LZSJ",Util.null2String(mainTableDataMap.get("qrlzrq")));
            tbody.put("INSERTTYPE",Util.null2String(mainTableDataMap.get("sqhjj")));
            list.add(tbody);
        }
