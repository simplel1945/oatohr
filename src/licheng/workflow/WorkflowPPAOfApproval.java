 ...
 *@创建时间  2020/5/9
 */
public class WorkflowPPAOfApproval extends BaseBean implements Action{
    private String interfaceName="试用期转正审批对接HR接口";
    /**
     * @Author 李志辉
     * @Description 试用期转正审批流程
     * @Date 2019/8/14
     * @Param [request]
    ...
    private net.sf.json.JSONObject getParam(Map<String,String> mainTableDataMap, int requestid, String formTableName){
        ...
        json.put("ProcName", "WSPROC_PPAOfApproval");
        //考核月份
...
//        }
        ...
        while (rs.next()){
            ...
            tbody.put("empname","");
            tbody.put("A84810",Util.null2String(mainTableDataMap.get("zd")));
            tbody.put("A84811",Util.null2String(mainTableDataMap.get("zj")));
            tbody.put("A84813",mainTableDataMap.get("hdzzgz")==null? 0:mainTableDataMap.get("hdzzgz"));
            tbody.put("A84814",mainTableDataMap.get("jxgz")==null? 0:mainTableDataMap.get("jxgz"));
            tbody.put("A84816",mainTableDataMap.get("jbgz")==null? 0:mainTableDataMap.get("jbgz"));
            tbody.put("ApplyDate",Util.null2String(mainTableDataMap.get("tbrq")));
            tbody.put("EffectiveDate",Util.null2String(mainTableDataMap.get("sysjb")));
            tbody.put("CorrectionType",Util.null2String(mainTableDataMap.get("zzlx")));
            tbody.put("CorrectOpinions",Util.null2String(mainTableDataMap.get("bmpy")));
            tbody.put("ProbationPostDate",Util.null2String(mainTableDataMap.get("sysje")));
            list.add(tbody);
        }
